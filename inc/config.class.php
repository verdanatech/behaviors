...
class PluginBehaviorsConfig extends CommonDBTM
{
    ...
    static function showConfigForm($item)
    {
      ...
      echo "<tr class='tab_bg_1'>";
      echo "<td>" . __('Hide satisfaction survey for ticket observer', 'behaviors');
      echo "</td><td>";
      Dropdown::showYesNo("is_satisfaction_hide_observer", $config->fields['is_satisfaction_hide_observer']);
      echo "</td><td colspan='2'></td></tr>";

      echo "<tr class='tab_bg_1'>";
      echo "<td>" . __('Hide satisfaction survey for ticket technician', 'behaviors');
      echo "</td><td>";
